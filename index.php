               ...
               <div class="row">
                  <div class="col-lg-7 align-self-center">
                     <div class="banner-text text-left iq-font-white">
                        <h1 class="iq-font-white iq-mb-20">Best Selling ICO Future Of Trading <b class="iq-font-yellow">CoinEX</b></h1>
                        <p>Simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        <a href="https://www.youtube.com/watch?v=0O2aH4XLbto" class="button-play video-popup">
                  ...
                  <div class="col-lg-5 text-center r9-mt-40">
                     <div class="iq-countdown">
                        ...
                        <a class="button iq-mb-20 bt-white" href="javascript:void(0)" role="button">Sign Up & Buy Token Now</a>
               ...
               <div class="row flex-row-reverse">
                  ...
                  <div class="col-lg-6 align-self-center">
                     <div class="heading-title left">
                        ...
                        <h2 class="iq-tw-6">ICO Launching Page for Your COINEX.</h2>
                     </div>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-title">
                        ...
                        <h2 class="title iq-tw-6">Tranding Platform</h2>
                     ...
                     <div class="light-bg">
                        <nav>
                           <div class="nav nav-tabs" id="nav-tab" role="tablist">
                              ...
                              <i class="la la-btc"></i><span>CoinEx: Token Usage</span></a>
                              ...
                              <i class="la la-usd"></i><span>CoinEx: Utility Token</span>
                              </a>
                              <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">
                              <i class="la la-eur"></i><span>CoinEx: Support</span>
                              </a>
                           </div>
                        </nav>
                        <div class="tab-content iq-mt-50" id="nav-tabContent">
                           <div class="tab-pane fade" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                              <div class="row">
                                 <div class="col-lg-6">
                                    <img class="img-fluid" src="assets/images/about/03.png" alt="#">
                                 </div>
                                 <div class="col-lg-6 align-self-center">
                                    <h3 class="iq-tw-6 iq-mb-15">CoinEx: Token Usage</h3>
                                    ...
                                    <ul>
                                       <li><i class="la la-arrow-right iq-mr-10"></i>Lorem Ipsum is simply dummy text</li>
                                       <li><i class="la la-arrow-right iq-mr-10"></i>Lorem Ipsum is simply dummy text</li>
                                       <li><i class="la la-arrow-right iq-mr-10"></i>Lorem Ipsum is simply dummy text</li>
                                       <li><i class="la la-arrow-right iq-mr-10"></i>Lorem Ipsum is simply dummy text</li>
                                       <li><i class="la la-arrow-right iq-mr-10"></i>Lorem Ipsum is simply dummy text</li>
            ...
            <div class="container">
               ...
               <div class="row iq-mt-100">
                  <div class="col-lg-4">
                     <div class="iq-fancy-box text-sm-center">
                        <div class="fancy-icon">
                           <img class="img-fluid" src="assets/images/fancy/1.png" alt="">
                        </div>
                  ...
                  <div class="col-lg-4">
                     <div class="iq-fancy-box text-sm-center">
                        <div class="fancy-icon">
                           <img class="img-fluid" src="assets/images/fancy/2.png" alt="">
                        </div>
                        <div class="fancy-content">
                           <h5 class="iq-tw-7">Professional Code</h5>
                           <p>Lorem Ipsum has been the industry's standard dummy text ever since the unknown printer Lorem </p>
                  ...
                  <div class="col-lg-4">
                     <div class="iq-fancy-box text-sm-center">
                        <div class="fancy-icon">
                           <img class="img-fluid" src="assets/images/fancy/3.png" alt="">
                        </div>
                        <div class="fancy-content">
                           <h5 class="iq-tw-7">Professional Code</h5>
                           <p>Lorem Ipsum has been the industry's standard dummy text ever since the unknown printer Lorem </p>
                  ...
                  <div class="col-lg-4">
                     <div class="iq-fancy-box text-sm-center">
                        <div class="fancy-icon">
                           <img class="img-fluid" src="assets/images/fancy/4.png" alt="">
                        </div>
                        <div class="fancy-content">
                           <h5 class="iq-tw-7">Professional Code</h5>
                           <p>Lorem Ipsum has been the industry's standard dummy text ever since the unknown printer Lorem </p>
                  ...
                  <div class="col-lg-4">
                     <div class="iq-fancy-box text-sm-center">
                        <div class="fancy-icon">
                           <img class="img-fluid" src="assets/images/fancy/5.png" alt="">
                        </div>
                        <div class="fancy-content">
                           <h5 class="iq-tw-7">Professional Code</h5>
                           <p>Lorem Ipsum has been the industry's standard dummy text ever since the unknown printer Lorem </p>
                  ...
                  <div class="col-lg-4">
                     <div class="iq-fancy-box text-sm-center">
                        <div class="fancy-icon">
                           <img class="img-fluid" src="assets/images/fancy/6.png" alt="">
                        </div>
                        <div class="fancy-content">
                           <h5 class="iq-tw-7">Professional Code</h5>
                           <p>Lorem Ipsum has been the industry's standard dummy text ever since the unknown printer Lorem </p>
         ...
         <section id="token" class="iq-Tranding-platform light-bg overview-block-ptb">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-title">
                        <small class="iq-font-green">Token</small>
                        <h2 class="title iq-tw-6">Token Sale</h2>
                        <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <table class="table table-bordered">
                           <tbody>
                              <tr>
                                 ...
                                 <td>15-1 May 2019: 40% bonus, 1 CoinEX ~ $14</td>
                              </tr>
                              <tr>
                                 <td>Pre-Sale Stage 2</td>
                                 <td>1-5 May 2019: 20% bonus, 1 CoinEX ~ $28</td>
                              </tr>
                              <tr>
                                 <td>Pre-Sale Stage 3</td>
                                 <td>9-14 May 2019: 10% bonus, 1 CoinEX ~ $30</td>
                              </tr>
                              <tr>
                                 <td>Main ICO</td>
                                 <td>28 May – 30 June: 0% bonus, 1 CoinEX ~ $33</td>
                              </tr>
                              <tr>
                                 <td>Emission Rate: </td>
                                 <td>No period</td>
                  ...
                  <div class="col-sm-12 iq-mt-60">
                     <div class="heading-title">
                        <h2 class="title iq-tw-6">Token Sale Proceeds</h2>
                        <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                     </div>
                  </div>
                  <div class="col-sm-12">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-title">
                        ...
                        <h2 class="title iq-tw-6">Company Roadmap</h2>
                        <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-lg-3 col-md-6">
                     <div class="our-team">
                        <div class="team-image">
                           <img alt="#" src="assets/images/team/01.jpg">
                           <ul class="social">
                        ...
                        <div class="team-content">
                           ...
                           <small class="iq-mt-5 d-block iq-mb-10 iq-font-yellow">CEO & Lead CoinEX</small>
                  ...
                  <div class="col-lg-3 col-md-6 r4-mt-40 ">
                     <div class="our-team">
                        <div class="team-image">
                           <img alt="#" src="assets/images/team/02.jpg">
                           <ul class="social">
                              <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
                              <li><a href="javascript:void(0)" class="fa fa-linkedin"></a></li>
                           </ul>
                  ...
                  <div class="col-lg-3 col-md-6 r4-mt-40 ">
                     <div class="our-team">
                        <div class="team-image">
                           <img alt="#" src="assets/images/team/03.jpg">
                           <ul class="social">
                              <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
                              <li><a href="javascript:void(0)" class="fa fa-linkedin"></a></li>
                           </ul>
                  ...
                  <div class="col-lg-3 col-md-6 r4-mt-40">
                     <div class="our-team">
                        <div class="team-image">
                           <img alt="#" src="assets/images/team/04.jpg">
                           <ul class="social">
                              <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
                              <li><a href="javascript:void(0)" class="fa fa-linkedin"></a></li>
                           </ul>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4 r4-mt-40 ">
                     <div class="our-team">
                        <div class="team-image">
                           <img alt="#" src="assets/images/team/07.jpg">
                           <ul class="social">
                              <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
                              <li><a href="javascript:void(0)" class="fa fa-linkedin"></a></li>
                           </ul>
               ...
               <div class="row">
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                        <img class="img-fluid center-block" src="assets/images/clients/white/01.png" alt="#">
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                        <img class="img-fluid center-block" src="assets/images/clients/white/02.png" alt="#">
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                        <img class="img-fluid center-block" src="assets/images/clients/white/03.png" alt="#">
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                        <img class="img-fluid center-block" src="assets/images/clients/white/04.png" alt="#">
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                        <img class="img-fluid center-block" src="assets/images/clients/white/05.png" alt="#">
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                        <img class="img-fluid center-block" src="assets/images/clients/white/06.png" alt="#">
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="Signal-partners">
                  ...
                  <div class="col-lg-6 r9-mt-40">
                     <div class="iq-accordion">
                        <div class="iq-ad-block ad-active">
                           <a href="javascript:void(0)" class="ad-title iq-tw-6">Ipsum is simply dummy the printing?</a>
                        ...
                        <div class="iq-ad-block">
                           <a href="javascript:void(0)" class="ad-title iq-tw-6">Dummy the printing and type setting?</a>
                        ...
                        <div class="iq-ad-block">
                           <a href="javascript:void(0)" class="ad-title iq-tw-6">Standard dummy since the 1500s?</a>
                           <div class="ad-details">It has survived not only five centuries, but also the leap into electronic typesetting. It has survived not only five centuries, but also the leap into electronic typesetting.</div>
                        </div>
                        <div class="iq-ad-block">
                           <a href="javascript:void(0)" class="ad-title iq-tw-6">It has survived five centuries?</a>
                           <div class="ad-details">It has survived not only five centuries, but also the leap into electronic typesetting. It has survived not only five centuries, but also the leap into electronic typesetting.</div>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="iq-blog-image clearfix">
                                 <div class="media-wrapper">
                                    <video style="width:100%;height:100%;" id="player1" poster="assets/video/01.jpg" controls preload="none">
                                       <source type="video/m4v" src="assets/video/01.html" />
                        ...
                        <div class="item">
                           <div class="iq-blog-box">
                              ...
                              <div class="iq-blog-detail">
                                 <div class="blog-title">
                                    <a href="blog-single.html">
                                       <h5 class="iq-tw-7 iq-mb-10">Blogpost With Slider</h5>
                                    </a>
                                 </div>
                                 <div class="blog-content">
                                    <p>Quae laboriosam sunt consectetur, assumenda provident lorem ipsum dolor sit amet, consectetur adipisicing elit. hic perspiciatis.</p>
               ...
               <div class="col-lg-6 iq-pl-50">
                  ...
                  <div class="iq-contact-box-01 iq-mt-40">
                     ...
                     <div class="contact-content">
                        ...
                        <span class="lead iq-tw-6"><a href="https://iqonicthemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fe8d8b8e8e918c8abe9d9197909b86d09d9193">[email&#160;protected]</a></span>
